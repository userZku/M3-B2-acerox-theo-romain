...
class MesuresIoT(Base):
    """Table des mesures IoT (exemple de table à ajouter)."""

    __tablename__ = "mesures_iot"
    __table_args__ = (UniqueConstraint("timestamp", "sensor_id", name="uq_mesures_iot_timestamp_sensor"),)
